...
const Ingressos = () => {
    const [tickets, setTickets] = useState<{ id: number, name: string; state: string; city: string, observation: string }[]>([]);
    ...
    const handleTicketCreated = (newTicket: { id: number, name: string; state: string; city: string, observation: string }) => {
